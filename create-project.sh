...
TEMPLATE_REPO="georgeyiakoumi/project-template"  # ← update to your GitHub username/template-repo-name
PROJECTS_DIR="$HOME/Projects"            # ← update to wherever you keep local projects
...
echo -e "  Local path: ${BLUE}$PROJECTS_DIR/$PROJECT_NAME${RESET}"
echo ""
